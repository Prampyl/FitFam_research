...
**Hypothesis:**
Retention rates are higher for cohorts that attend sessions led by "High Quality" leaders (defined by high consistency, tenure, and rating proxies) compared to sporadic leaders.
...
## 4. Next Actions
- Execute **Step 1 (Data Discovery)** immediately to confirm Leader ID availability.
- Proceed to **Step 2 & 3 (Feature Engineering)**.
